...
data = {'pagesets': [{'files': [{'src': ['src/pages/*.html',
                                 ...
                                 'template': 'src/layouts/layout.html',
                                 'dest': ''},
                                {'src': ['src/pages/tools/*.html',
                                         'src/pages/tools/*.md'],
                                 'template': 'src/layouts/layout.html',
                                 'dest': 'tools'},
                                # make a new fileset for index pages
                                ],
                      ...
                      {'files': [{'src': ['src/pages/editorial/2017-2018/*.html'],
                                  'template': 'editorial-article.html',
                                  'dest': 'editorial'},
                                  {'src': ['src/pages/editorial/2017-2018/qanda.yaml'],
                                   'template': 'qanda.html',
                                   'dest': 'editorial'},
                                  {'src': [('src/pages/editorial/2017-2018/'
                                            'meme-of-the-week.yaml')],
